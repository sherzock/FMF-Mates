...
% 2. Intervalo de interpolación y ploteo [limite_inferior, limite_superior]
intervalo = [0, 1];

% 3. Valor de la función al principio del intervalo  (rectangulo_izq), al medio
% (rectangulo_medio), al final del intervalo (rectangulo_der)
r = f(intervalo(1));
